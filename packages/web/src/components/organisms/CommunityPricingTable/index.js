...
const StyledNumberFormat = styled.span`
  ...
  color: ${p => palette(p.color, 'darker-30')};
`;
    ...
    <>
      {estimated &&
        <StyledBlockNp size="title">
          ...
          <StyledNumberFormat weight="weight.medium" color="secondary">{formatMoney(from)}</StyledNumberFormat> <Span weight="medium" size="title" palette="secondary" variation="darker-30"> to </Span> <StyledNumberFormat weight="weight.medium" color="secondary">{formatMoney(to)}</StyledNumberFormat> <Span weight="medium" size="title" palette="secondary" variation="darker-30"> per month*</Span>
        </StyledBlockNp>
      }
      {!estimated &&
        <StyledBlockNp size="title">
          <StyledBlockSp size="body" palette="slate">The estimated pricing for {name} starts around</StyledBlockSp>
          <StyledNumberFormat weight="weight.medium" color="secondary">{formatMoney(price)}</StyledNumberFormat> <Span weight="medium" size="title" palette="secondary" variation="darker-30"> per month*</Span>
        </StyledBlockNp>
      }
      {pricesList.length > 0 &&
