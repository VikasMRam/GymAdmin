...
storiesOf('Organisms|CommunityTile', module)
  ...
  .add('isFavourite and canFavourite', () => <div style={{ maxWidth: '380px' }} ><CommunityTile community={RhodaGoldmanPlaza} canFavourite isFavourite {...defaultProps} /></div>)
  .add('column layout', () => <CommunityTile layout="column" community={RhodaGoldmanPlaza} {...defaultProps} />)
  .add('column layout and size', () => <CommunityTile layout="column" size="small" community={RhodaGoldmanPlaza} {...defaultProps} />)
  .add('column layout and no rating', () => <CommunityTile layout="column" community={RhodaGoldmanPlazaNoRating} {...defaultProps} />)
  .add('column layout and plusCategory community', () => <CommunityTile layout="column" community={RhodaGoldmanPlazaPlus} {...defaultProps} />)
  .add('column layout and showDescription', () => <CommunityTile layout="column" community={RhodaGoldmanPlaza} showDescription {...defaultProps} />)
