...
const FamilyDetailsForm = ({
  ...
  isWon,
  client,
  onEditStageDetailsClick,
  onEditStatusDetailsClick,
  handleCreate = () => {},
  handleInputChange = () => {},
  handleChange = () => {},
  ...props
}) => {
  const handleLookingForChange = (event, value) => {
    if (value === 'Self') {
  ...
  const tagColumn = { typeInfo: { api: `${apiUrl}/platform/tags?filter[category]=Client&filter[name]=` }, value: 'tag.name' };
