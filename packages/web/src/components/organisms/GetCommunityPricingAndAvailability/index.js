...
const GetCommunityPricingAndAvailability = ({ completedAssessment, community: { id, startingRate, rates, propInfo: { maxRate }, propRatings: { reviewsValue, numReviews } }, buttonTo, onClick }) => {
  return (
    <Box>
