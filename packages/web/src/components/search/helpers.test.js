...
it('filter search params checks against searchWhiteListParmas correctly', () => {
  const fullParams = {
    size: 'small', dummy: '', some: '',
  };
  expect(filterSearchParams(fullParams)).toEqual({ size: 'small'});
});
...
it('type of care filters are transformed into url correctly', () => {
  ...
  expect(filterLinkPath({ ...baseParams, ...filterParams }, { toc: 'assisted-living' }))
    .toEqual({
      path: '/assisted-living/california/san-francisco?size=small',
      selected: true,
    });
  ...
  expect(filterLinkPath({ ...baseParams, ...filterParams }, { toc: 'independent-living' }))
    .toEqual({
      path: '/independent-living/california/san-francisco?size=small',
      selected: false,
    });
  ...
  expect(filterLinkPath({ ...baseParams, ...filterParams }, { toc: 'nursing-homes' }))
    .toEqual({
      path: '/nursing-homes/california/san-francisco?size=small',
      selected: true,
    });
});
...
it('size & budget & radius filters are transformed into url correctly', () => {
  ...
  expect(filterLinkPath({ ...baseParams, ...filterParams }, { budget: 2000 }))
    .toEqual({
      path: '/assisted-living/california/san-francisco?budget=2000&size=small',
      selected: false,
    });
  //
  ...
  expect(filterLinkPath({ ...baseParams, ...filterParams }, { size: 'small' }))
    .toEqual({
      path: '/assisted-living/california/san-francisco?budget=4000',
      selected: true,
    });
  ...
  expect(filterLinkPath({ ...baseParams, ...filterParams }, { size: 'small' }))
    .toEqual({
      path: '/assisted-living/california/san-francisco?budget=4000&size=small',
      selected: false,
    });
});
