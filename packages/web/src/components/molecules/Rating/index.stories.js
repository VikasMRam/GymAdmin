...
storiesOf('Molecules|Rating', module)
  ...
  .add('small 3.1', () => <Rating value={3.1} size="small" />)
  .add('small 3.9', () => <Rating value={3.9} size="small" />)
  .add('small 3.99', () => <Rating value={3.99} size="small" />)
  .add('small 0.2', () => <Rating value={0.01} size="small" />);
