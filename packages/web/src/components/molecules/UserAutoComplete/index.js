...
import { CUSTOMER_ROLE_PARAM, PROVIDER_ROLE_PARAM, AGENT_ROLE_PARAM } from 'sly/common/constants/roles';
...
export default class UserAutoComplete extends Component {
  static propTypes = {
    role: oneOf([CUSTOMER_ROLE_PARAM, PROVIDER_ROLE_PARAM, AGENT_ROLE_PARAM]),
    onChange: func,
    onBlur: func,
  };
