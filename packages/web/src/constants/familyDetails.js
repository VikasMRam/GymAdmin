...
FAMILY_CLOSE_COMMUNITY[FAMILY_CLOSE_REJECT] = [FAMILY_CLOSE_NOT_FIT, FAMILY_CLOSE_NOT_PRESENT, FAMILY_CLOSE_OVER_BUDGET, FAMILY_CLOSE_OUTSIDE, FAMILY_CLOSE_ALREADY_WORKING];
