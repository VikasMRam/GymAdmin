...
import { LOCAL_EXPERT_OPTIONS } from 'sly/web/assessment/constants';
  ...
  <Wrapper hasSecondColumn={hasTip}>
    <Box>
      <Heading level="subtitle" weight="medium" pad="xLarge">
        Are you interested in working with a Seniorly Local Advisor? They can help you find senior living options that fit your budget and care needs.
      </Heading>
