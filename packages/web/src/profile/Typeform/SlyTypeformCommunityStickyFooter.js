...
import SlyTypeformCommunityActions from 'sly/web/profile/Typeform/SlyTypeformCommunityActions';
...
const SlyTypeformCommunityStickyFooter = ({ community, isAlreadyPricingRequested, locTrack, isActiveAdult, isZillowAd, ...props }) => {
  ...
  return (
    <Wrapper>
      ...
      <Block my="auto" ml="auto"><SlyTypeformCommunityActions community={community} isAlreadyPricingRequested={isAlreadyPricingRequested} locTrack={locTrack} {...props} /></Block>
    </Wrapper>

  );
};

SlyTypeformCommunityStickyFooter.typeHydrationId = 'SlyTypeformCommunityStickyFooter';
SlyTypeformCommunityStickyFooter.propTypes = {
...
export default SlyTypeformCommunityStickyFooter;
