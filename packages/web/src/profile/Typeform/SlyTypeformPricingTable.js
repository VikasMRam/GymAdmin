...
import { Block, Span, Paragraph, space, Button } from 'sly/common/system';
...
const SlyTypeformCommunityPricingTable = (props) => {
  const {
    pricesList, estimatedPriceList, newPricesList, hasAlreadyRequestedPricing, community, buttonProps,
  } = props;
      ...
      <Block>
        ...
        }
        {
          hasAlreadyRequestedPricing ?
            ...
            </StyledButton> :  <SlyTypeform {...props} />
        }
...
SlyTypeformCommunityPricingTable.propTypes = {
...
SlyTypeformCommunityPricingTable.defaultProps = {
  pricesList: [],
  estimatedPriceList: [],
  buttonProps: {},
};

SlyTypeformCommunityPricingTable.typeHydrationId = 'CommunityPricingTable';


export default SlyTypeformCommunityPricingTable;
