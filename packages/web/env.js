...
module.exports.HOST = envPick(process.env.HOST, 'https://www.seniorly.dev');
...
module.exports.API_URL = envPick(process.env.API_URL, 'https://www.seniorly.dev/v0');
module.exports.CMS_URL = envPick(process.env.CMS_URL, 'http://localhost:1337');
module.exports.DOMAIN = envPick(process.env.DOMAIN, 'seniorly.dev');
