...
module.exports.HOST = envPick(process.env.NEXT_PUBLIC_HOST || process.env.HOST, 'https://www.seniorly.dev');
...
module.exports.API_URL = envPick(process.env.NEXT_PUBLIC_API_URL || process.env.API_URL, 'https://www.seniorly.dev/v0');
module.exports.CMS_URL = envPick(process.env.NEXT_PUBLIC_CMS_URL || process.env.CMS_URL, 'https://cms.seniorly.dev ̰');
module.exports.DOMAIN = envPick(process.env.NEXT_PUBLIC_DOMAIN || process.env.DOMAIN, 'seniorly.dev');
...
module.exports.HIDE_CHATBOX = envPick(process.env.NEXT_PUBLIC_HIDE_CHATBOX || process.env.HIDE_CHATBOX, false);
