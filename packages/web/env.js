...
module.exports.HOST = envPick(process.env.HOST, 'http://www.localtest.me');
...
module.exports.API_URL = envPick(process.env.API_URL, 'http://www.localtest.me/v0');
module.exports.CMS_URL = envPick(process.env.CMS_URL, 'http://localhost:1337');
module.exports.DOMAIN = envPick(process.env.DOMAIN, 'localtest.me');
