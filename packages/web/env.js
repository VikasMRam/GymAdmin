...
module.exports.CMS_URL = envPick(process.env.NEXT_PUBLIC_CMS_URL || process.env.CMS_URL, 'http://localhost:1337');
module.exports.DOMAIN = envPick(process.env.NEXT_PUBLIC_DOMAIN || process.env.DOMAIN, 'www.seniorly.dev');
