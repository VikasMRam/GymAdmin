...
module.exports.HOST = envPick(process.env.NEXT_PUBLIC_HOST || process.env.HOST, 'http://www.localtest.me');
...
module.exports.API_URL = envPick(process.env.NEXT_PUBLIC_API_URL || process.env.API_URL, 'http://www.localtest.me/v0');
module.exports.CMS_URL = envPick(process.env.NEXT_PUBLIC_CMS_URL || process.env.CMS_URL, 'http://localhost:1337');
module.exports.DOMAIN = envPick(process.env.NEXT_PUBLIC_DOMAIN || process.env.DOMAIN, 'localtest.me');
