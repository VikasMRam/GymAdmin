...
const menuItems = [
  ...
  { label: 'Communities', icon: 'house', iconSize: 'regular', palette: 'slate', variation: 'filler', href: ADMIN_DASHBOARD_COMMUNITIES_PATH, role: AGENT_ADMIN_ROLE, onClick: onMenuItemClick },
