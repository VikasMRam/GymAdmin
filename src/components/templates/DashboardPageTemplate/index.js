...
const menuItems = [
  ...
  { label: 'Communities', icon: 'house', iconSize: 'regular', palette: 'slate', variation: 'filler', href: DASHBOARD_COMMUNITIES_PATH, role: PLATFORM_ADMIN_ROLE, onClick: onMenuItemClick },
