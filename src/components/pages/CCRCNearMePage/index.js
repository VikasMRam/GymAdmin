  ...
  const TableOfContents = () => {
    return (
      <>
        ...
        <Paragraph>
          <StyledLink
            href={`#${sectionIdMap.ccrc}`}
            onClick={e => handleAnchor(e, ccrcRef)}
          >
            What is a Continuing Care Retirement Community (CCRC)?
          </StyledLink>
          <StyledLink
            href={`#${sectionIdMap.procon}`}
            onClick={e => handleAnchor(e, proconRef)}
          >
          ...
          <StyledLink
            href={`#${sectionIdMap.ccrcvsal}`}
            onClick={e => handleAnchor(e, ccrcvsalRef)}
          >
            CCRC vs. Assisted Living
          </StyledLink>
          <StyledLink
            href={`#${sectionIdMap.ccrcvshc}`}
            onClick={e => handleAnchor(e, ccrcvshcRef)}
          >
            CCRC vs. Assisted Living
          </StyledLink>
          <StyledLink
