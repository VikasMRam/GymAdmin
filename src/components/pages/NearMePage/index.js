...
import { ResponsiveImage, Label, Heading, Paragraph } from 'sly/components/atoms';
...
const NearMePage = ({
  ...
  const SEOContentAL = () => {
    return (
      <>
        <StyledHeading level="title"size="title" _ref={topRef}>
          Table of Contents
        </StyledHeading>
        <StyledArticle>
          <ul>
        ...
        <StyledArticle>
          <StyledHeading level="title" size="title" _ref={nextRef}>
            Next Steps
          </StyledHeading>
          <Paragraph>
