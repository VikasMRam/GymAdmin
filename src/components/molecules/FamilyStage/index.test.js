...
import TestUser from 'sly/../private/storybook/sample-data/user-amal-francis.json';
import TestClient from 'sly/../private/storybook/sample-data/client-pranesh-kumar.json';
