...
const GetCommunityPricingAndAvailability = ({ community: { startingRate, propRatings: { reviewsValue, numReviews } }, buttonTo }) => (
  <Box>
    ...
    {getButton(startingRate, { to: buttonTo, children: 'Get detailed pricing' })}
    {startingRate > 0 &&
