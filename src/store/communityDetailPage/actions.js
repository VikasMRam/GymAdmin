...
export const COMMUNITY_DETAIL_TOGGLE_FAVOURITE_MODAL_OPEN = 'COMMUNITY_DETAIL_TOGGLE_FAVOURITE_MODAL_OPEN';
...
export const toggleFavouriteModal = () => ({
  type: COMMUNITY_DETAIL_TOGGLE_FAVOURITE_MODAL_OPEN,
});
