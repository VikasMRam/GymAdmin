...
test('resourceCreateRequest', () => {
  expect(actions.resourceCreateRequest('resources', { title: 'test' })).toEqual(expect.objectContaining({
...
test('resourceCreateFailure', () => {
  expect(actions.resourceCreateFailure('resources', 'error', 'request')).toEqual(expect.objectContaining({
...
test('resourceListReadRequest', () => {
  expect(actions.resourceListReadRequest('resources', { fields: 'test' })).toEqual(expect.objectContaining({
...
test('resourceListReadSuccess', () => {
  expect(actions.resourceListReadSuccess('resources', [1, 2, 3], 'request')).toEqual(expect.objectContaining({
...
test('resourceListReadFailure', () => {
  expect(actions.resourceListReadFailure('resources', 'error', 'request')).toEqual(expect.objectContaining({
...
test('resourceDetailReadRequest', () => {
  expect(actions.resourceDetailReadRequest('resources', 1)).toEqual(expect.objectContaining({
...
test('resourceDetailReadFailure', () => {
  expect(actions.resourceDetailReadFailure('resources', 'error', 'request')).toEqual(expect.objectContaining({
...
test('resourceUpdateRequest', () => {
  expect(actions.resourceUpdateRequest('resources', 1, { title: 'test' })).toEqual(expect.objectContaining({
...
test('resourceUpdateFailure', () => {
  expect(actions.resourceUpdateFailure('resources', 'error', 'request')).toEqual(expect.objectContaining({
...
test('resourceDeleteRequest', () => {
  expect(actions.resourceDeleteRequest('resources', 1)).toEqual(expect.objectContaining({
...
test('resourceDeleteSuccess', () => {
  expect(actions.resourceDeleteSuccess('resources', 'request')).toEqual(expect.objectContaining({
...
test('resourceDeleteFailure', () => {
  expect(actions.resourceDeleteFailure('resources', 'error', 'request')).toEqual(expect.objectContaining({
