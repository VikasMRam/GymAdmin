export const PressTileContents = [
  ...
  {
    text: `Seniorly tracks assisted living openings to facilitate short-term stays in communities that traditionally 
      only offer longer-term care options. This service helps fill gaps for assisted living facilities and bridge care 
