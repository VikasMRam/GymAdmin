...
const config = {
  ...
  production: {
    ...
    isDev: false,
    basename: process.env.BASENAME || '',
    host: process.env.HOST || 'slyreact-prod.us-west-2.elasticbeanstalk.com',
    port: process.env.PORT || 8080,
    apiUrl: process.env.API_URL || 'https://slyapi-prod.us-west-2.elasticbeanstalk.com/v0',
    authTokenUrl: process.env.AUTH_URL ||  'https://slyapi-prod.us-west-2.elasticbeanstalk.com/users/auth_token',
    cookieDomain: process.env.DOMAIN || 'us-west-2.elasticbeanstalk.com',
