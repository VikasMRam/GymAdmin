...
const config = {
  ...
  production: {
    ...
    apiUrl: process.env.API_URL || 'http://slyapi-prod.us-west-2.elasticbeanstalk.com/v0',
    authTokenUrl: process.env.AUTH_URL ||  'http://slyapi-prod.us-west-2.elasticbeanstalk.com/users/auth_token',
