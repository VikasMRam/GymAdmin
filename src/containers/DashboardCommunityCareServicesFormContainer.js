...
export default class DashboardCommunityCareServicesFormContainer extends Component {
  ...
  handleSubmit = (values) => {
    ...
    let community = immutable.wrap(pick(rawCommunity, ['id', 'type', 'attributes', 'relationships', 'attributes.propInfo.careServices', 'attributes.propInfo.nonCareServices']))
      .set('attributes.propInfo.careServices', values.propInfo.careServices)
      .set('attributes.propInfo.nonCareServices', values.propInfo.nonCareServices);

    community = community.value();
    return updateCommunity({ id }, community);
  };
