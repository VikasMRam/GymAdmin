...
import WhenForm from 'sly/components/organisms/WhenForm';
...
class WhenFormContainer extends Component {
  static propTypes = {
...
export default connect(mapStateToProps)(WhenFormContainer);
