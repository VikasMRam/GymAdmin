...
const mapDispatchToProps = dispatch => ({
  ...
  onClick:()=>{console.log('Saw this on general  Click');
    return dispatch(modalShow('login'))},//{console.log('Saw this on Click')},
  onLogout:()=>{console.log('Saw this on logout Click')},
  onLogin:()=>{console.log('Saw this on login Click')},
  onFacebookLogin:()=>{console.log('Saw this on fb Click')},
  onClose:()=>{console.log('Saw this on Close')}
});
